...
var $prevImage = (0, _jquery2.default)('.Edit-label img');
...
var $el = (0, _jquery2.default)('#chat');
var $menuLeft = $el.find('#chat-leftMenu');
var $opacity = $el.find('.Chat-opacity');

var chat = {
  leftShow: function leftShow(ev) {
    ev.preventDefault();
    $opacity.show();
    $menuLeft.animate({ left: '0px' }, 800);
  },
  leftHide: function leftHide() {
    $opacity.hide();
...
var _menu = require('src/client/js/menu');

var _menu2 = _interopRequireDefault(_menu);

var _chat = require('src/client/js/chat');

var _chat2 = _interopRequireDefault(_chat);

var _userMenu = require('src/client/js/userMenu');

var _userMenu2 = _interopRequireDefault(_userMenu);

var _login = require('src/client/js/login');

var _login2 = _interopRequireDefault(_login);

var _requestSong = require('src/client/js/requestSong');

var _requestSong2 = _interopRequireDefault(_requestSong);

var _loginDropdown = require('src/client/js/loginDropdown');

var _loginDropdown2 = _interopRequireDefault(_loginDropdown);

var _slider = require('src/client/js/slider');

var _slider2 = _interopRequireDefault(_slider);

var _share = require('src/client/js/share');

var _share2 = _interopRequireDefault(_share);

var _admin = require('src/client/js/admin');
...
(0, _jquery2.default)(function () {
  var $buttonMenu = (0, _jquery2.default)('#btn-menu');
  ...
  (0, _jquery2.default)('.slider4').bxSlider({
    mode: 'horizontal',
    slideWidth: 350,
    minSlides: 1,
    maxSlides: 4,
  ...
  // events
  $buttonMenu.click(_menu2.default.show);
  $buttonMore.click(_chat2.default.leftShow);
  $buttonLogin.click(_login2.default.show);
  $buttonReqSong.click(_requestSong2.default.show);
  $opacityChat.click(_chat2.default.leftHide);
  $avatar.click(_userMenu2.default.toggle);
  $body.click(_userMenu2.default.hide);
  $uploadImage.change(_admin2.default.change);
  $opacityBody.click(function (ev) {
    _menu2.default.hide();
...
},{"jquery":1,"src/client/js/admin":2,"src/client/js/chat":3,"src/client/js/login":5,"src/client/js/loginDropdown":6,"src/client/js/menu":7,"src/client/js/requestSong":8,"src/client/js/share":9,"src/client/js/slider":10,"src/client/js/userMenu":11}],5:[function(require,module,exports){
'use strict';
...
var $el = (0, _jquery2.default)('#login');
var $opacity = (0, _jquery2.default)('#opacity');

// button close
$el.find('.icon-close').click(function (ev) {
  ev.preventDefault();
  login.hide();
});
...
var $el = (0, _jquery2.default)('#login-dropdown');
...
var $el = (0, _jquery2.default)('#menu');
var $opacity = (0, _jquery2.default)('#opacity');
...
var $el = (0, _jquery2.default)('#requestSong');
var $opacity = (0, _jquery2.default)('#opacity');
...
var shareFacebook = '//www.facebook.com/share.php';
var shareTwitter = '//twitter.com/intent/tweet';

var titlePost = (0, _jquery2.default)('#title-post').text();
var username = 'radiouniversal101.3FM';
var text = 'Me gusto este artículo sobre ' + titlePost;

var generateUrl = {
  facebook: function facebook() {
    return shareFacebook + '?u=' + window.location.href;
  },
  twitter: function twitter() {
    return shareTwitter + '?text=' + text + '&url=' + window.location.href + '&via=' + username;
  }
};

if ((0, _jquery2.default)('#btns-share').length) {
  (0, _jquery2.default)('#share-facebook').attr('href', generateUrl.facebook());
  (0, _jquery2.default)('#share-twitter').attr('href', generateUrl.twitter());
}
...
var $el = (0, _jquery2.default)('#user-menu');
